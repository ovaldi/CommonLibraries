...
namespace Kooboo.Common.Windows.Drawing
{
    /// <summary>
    /// 
    /// </summary>
    ...
    public class DefaultWebPageCaptureProvider : IWebPageCaptureProvider
    {
        ...
        public void Navigate(string url, NameValueCollection cookies, EventHandler<WebPageCapturedEventArgs> captured)
        {
            _captured = captured;
        ...
        /// <param name="url">The URL.</param>
        public static void SetCookies(NameValueCollection cookies, string url = null)
        {
            lock (SetCookiesLocker)
            {
                foreach (var key in cookies.AllKeys)
                {
                    ...
                    SetWinINETCookieString(url, key, cookies[key]);
                }
            }
        }
