    ...
    public static class UrlUtility
    {
        ...
        public static string MapPath(string url)
        {
            ...
            if (physicalPath == null)
            {
                ...
                physicalPath = Path.Combine(Kooboo.Common.Settings.BaseDirectory, physicalPath);
            }
            return physicalPath;
        }
        #endregion

        #region CombineQueryString
