...
namespace Kooboo.Common.CachingSync.Azure
{
    /// <summary>
    /// 
    /// </summary>
    [Kooboo.Common.ObjectContainer.Dependency.Dependency(typeof(ICacheExpiredNotifier), Key = "AzureInstancesCachingNotifier")]
    public class AzureInstancesCachingNotifier : ICacheExpiredNotifier
    {
        #region Methods
